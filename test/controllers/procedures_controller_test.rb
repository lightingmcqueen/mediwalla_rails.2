...
class ProceduresControllerTest < ActionController::TestCase
  ...
  test "should create procedure" do
    assert_difference('Procedure.count') do
      post :create, procedure: { clinic_id: @procedure.clinic_id, description: @procedure.description, title: @procedure.title }
    end
  ...
  test "should update procedure" do
    patch :update, id: @procedure, procedure: { clinic_id: @procedure.clinic_id, description: @procedure.description, title: @procedure.title }
    assert_redirected_to procedure_path(assigns(:procedure))
  end
